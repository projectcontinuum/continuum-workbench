...
export interface SvgViewerDialogProps {
    open: boolean;
    svgContent: string | null;
    onClose: () => void;
}

export function SvgViewerDialog({ open, svgContent, onClose }: SvgViewerDialogProps) {
    ...
    return (
        ...
        >
            <DialogTitle>SVG Viewer</DialogTitle>
            <Tooltip title={copySuccess ? 'Copied!' : 'Copy SVG to clipboard'}>
                <IconButton
                    aria-label="copy"
                    onClick={handleCopy}
                    sx={{
                        ...
                        top: 8,
                        color: (theme) =>
                            copySuccess ? theme.palette.success.main : theme.palette.grey[500],
                    }}
                >
                    <ContentCopyIcon />
                </IconButton>
